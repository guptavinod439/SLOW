 ...
 *
 */
package com.example.gupta.slow.NearbyLocations.GMap;
...
import com.example.gupta.slow.NavigationDrawerActivity;
...
import com.example.gupta.slow.Adapter.CustomPlacesAdapter;
//import com.example.gupta.slow.MainActivity;
import com.example.gupta.slow.NearbyLocations.GeometryController;
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Toast.makeText(ListHealthCenters.this, e.getMessage(), Toast.LENGTH_LONG).show();
                   NavigationDrawerActivity.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
            }
